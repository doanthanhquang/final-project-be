...
class EmailController extends Controller
{
    ...
    public function sendEmail(Request $request)
    {
        ...
        try {
            $emailId = $this->gmailService->sendEmail($provider, $request->all());
    ...
    public function replyEmail(Request $request, string $emailId)
    {
        ...
        try {
            $replyId = $this->gmailService->replyEmail(
                $provider,
                $emailId,
                $request->input('body'),
    ...
    public function forwardEmail(Request $request, string $emailId)
    {
        ...
        try {
            $forwardId = $this->gmailService->forwardEmail(
                $provider,
                $emailId,
                $request->input('to'),
    ...
    /**
     * POST /api/email-provider/disconnect
     */
